...
blender_archive_path="${PWD}/.local/blenders/extension-builder-blender.tar.xz"
blender_path="${PWD}/.local/blenders/extension-builder-blender/blender"
...
"$blender_path" --command extension build \
  --source-dir src/fluffy_computing_machine \
